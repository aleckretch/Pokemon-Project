 ...
 */
public class Mankey extends JFrame{
	...
	public Mankey() {
		...
		l1.setIcon(new ImageIcon("pics/MankeyLarge.png"));
		...
		JLabel l8 = new JLabel("Pig Monkey");
