 ...
 */
public class Rattata extends JFrame{
	...
	public Rattata() {
		...
		l1.setIcon(new ImageIcon("pics/RattataLarge.png"));
		...
		JLabel l14 = new JLabel("Fighting");
