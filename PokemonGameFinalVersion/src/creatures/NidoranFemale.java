 ...
 */
public class NidoranFemale extends JFrame{
	...
	public NidoranFemale() {
		...
		l1.setIcon(new ImageIcon("pics/NidoranLarge.png"));
		...
		JLabel l8 = new JLabel("Poison Pin");
