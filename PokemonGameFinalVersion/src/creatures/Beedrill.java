 ...
 */
public class Beedrill extends JFrame{
	...
	public Beedrill() {
		...
		l1.setIcon(new ImageIcon("pics/BeedLarge.png"));
		...
		JLabel l8 = new JLabel("Poison Bee");
